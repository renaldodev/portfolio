...
const SOCIALS_LIST = [
  { key: 'socialGitHub', href: 'https://github.com/renaldodev' },
  { key: 'socialLinkedIn', href: 'https://linkedin.com/in/renaldodev' },
  { key: 'socialEmail', href: 'mailto:renaldo@example.com' },
];
