...
- **Global scope**: `/home/renaldodev/www/portfolio/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/renaldodev/www/portfolio/.claude/notes/`)
...
2. Glob `/home/renaldodev/www/portfolio/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/renaldodev/www/portfolio/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/renaldodev/www/portfolio/.claude/notes/` — works in any directory
